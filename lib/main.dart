...
Future<void> main() async {
  ...
  if (firebaseReady) {
    ...
    try {
      ...
      // FlutterSceneDelegate/UIScene migration (FlutterFire #17854).
      // A hang here blocks app startup past iOS's launch watchdog
      // timeout, which kills the app — looks like a crash on open.
